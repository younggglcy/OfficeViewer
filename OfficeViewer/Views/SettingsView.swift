...
struct SettingsView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            Text("Configure CLI commands to open decoded Office files. Use ${folder} as placeholder for the folder path.")
                .font(.caption)
...
struct CommandEditor: View {
    ...
    init(command: OpenCommand, onSave: @escaping (OpenCommand) -> Void, onCancel: @escaping () -> Void) {
